function tensors = C3vTensor
%TdTensor Prompts user for C3v tensor information and outputs Cijk and Dijk
...
%   plus an example particle shape stored in shapeB
    ...
    tensorDisp(1,2,1).C = '-c3';
    tensorDisp(1,1,2).C = '-c3';
    tensorDisp(2,1,1).C = '-c3';
    tensorDisp(2,2,2).C = 'c3';
    ...
    tensors.Cijk(1,2,1) = -CArray(3);
    tensors.Cijk(1,1,2) = -CArray(3);
    tensors.Cijk(2,1,1) = -CArray(3);
    tensors.Cijk(2,2,2) = CArray(3);
