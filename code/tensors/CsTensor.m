function tensors = CsTensor
%TdTensor Prompts user for Cs tensor information and outputs Cijk and Dijk
...
%   plus an example particle shape stored in shapeB
    ...
    tensorDisp(3,3,2).C = 'c1';
    tensorDisp(3,2,3).C = 'c1';
    
	tensorDisp(3,3,1).C = 'c2';
	tensorDisp(3,1,3).C = 'c2';
    
	tensorDisp(2,3,3).C = 'c3';
    
    tensorDisp(2,2,2).C = 'c4';
    ...
    tensorDisp(1,3,3).C = 'c7';
    
    tensorDisp(1,2,2).C = 'c8';
	
	tensorDisp(1,2,1).C = 'c9';
	tensorDisp(1,1,2).C = 'c9';
	
    tensorDisp(1,1,1).C = 'c10';
    ...
    CPrompt = 'Please enter values for [c1, c2, c3, c4, c5, c6, c7, c8, c9, c10]. \n';
    CArray = input(CPrompt);
    
    tensors.Cijk(3,3,2) = CArray(1);
    tensors.Cijk(3,2,3) = CArray(1);
    
    tensors.Cijk(3,3,1) = CArray(2);
    tensors.Cijk(3,1,3) = CArray(2);
    
    tensors.Cijk(2,3,3) = CArray(3);
    
    tensors.Cijk(2,2,2) = CArray(4);
    ...
    tensors.Cijk(1,3,3) = CArray(7);
    
    tensors.Cijk(1,2,2) = CArray(8);
    
    tensors.Cijk(1,2,1) = CArray(9);
    tensors.Cijk(1,1,2) = CArray(9);
    
    tensors.Cijk(1,1,1) = CArray(10);
