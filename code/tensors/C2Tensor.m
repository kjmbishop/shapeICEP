function tensors = C2Tensor
%TdTensor Prompts user for C2 tensor information and outputs Cijk and Dijk
...
%   plus an example particle shape stored in shapeB
	...
	tensorDisp(3,1,1).C = 'c4';
    
	tensorDisp(2,3,2).C = 'c5';
    tensorDisp(2,2,3).C = 'c5';
    
    tensorDisp(2,1,3).C = 'c6';
    tensorDisp(2,3,1).C = 'c6';
    
    tensorDisp(1,2,3).C = 'c7';
    tensorDisp(1,3,2).C = 'c7';
	
	tensorDisp(1,3,1).C = 'c8';
	tensorDisp(1,1,3).C = 'c8';
    ...
    CPrompt = 'Please enter values for [c1, c2, c3, c4, c5, c6, c7, c8]. \n';
    ...
    tensors.Cijk(3,1,1) = CArray(4);
    
    tensors.Cijk(2,3,2) = CArray(5);
    tensors.Cijk(2,2,3) = CArray(5);
    
    tensors.Cijk(2,3,1) = CArray(6);
    tensors.Cijk(2,1,3) = CArray(6);
    
    tensors.Cijk(1,2,3) = CArray(7);
    tensors.Cijk(1,3,2) = CArray(7);
    
    tensors.Cijk(1,3,1) = CArray(8);
    tensors.Cijk(1,1,3) = CArray(8);
