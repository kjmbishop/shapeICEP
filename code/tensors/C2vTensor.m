function tensors = C2vTensor
%TdTensor Prompts user for C2v tensor information and outputs Cijk and Dijk
...
%   plus an example particle shape stored in shapeB
    ...
    tensorDisp(1,1,3).C = 'c5';
    tensorDisp(1,3,1).C = 'c5';
    ...
    CPrompt = 'Please enter values for [c1, c2, c3, c4, c5]. \n';
    ...
    tensors.Cijk(1,1,3) = CArray(5);
    tensors.Cijk(1,3,1) = CArray(5);
