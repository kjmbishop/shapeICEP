function tensors = S6Tensor
%TdTensor Prompts user for S6 tensor information and outputs Cijk and Dijk
...
%   plus an example particle shape stored in shapeB
    ...
    tensors.shapeB(6,7) = 0.5;
    tensors.shapeB(12,13) = 0.5*1i;
    tensors.shapeB(2,1) = -0.1;
	tensors.shapeB(4,4) = 0.3;
