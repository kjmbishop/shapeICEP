function tensors = D2hTensor
%TdTensor Prompts user for D2h tensor information and outputs Cijk and Dijk
...
%   plus an example particle shape stored in shapeB
    ...
    DPrompt = 'Please enter values for [d1, d2, d3] such that d1 <= d2 <= d3. \n';
