function tensors = C3hTensor
%TdTensor Prompts user for C3h tensor information and outputs Cijk and Dijk
...
%   plus an example particle shape stored in shapeB
    ...
    tensorDisp(1,2,2).C = 'c1';
    tensorDisp(2,2,1).C = 'c1';
    tensorDisp(2,1,2).C = 'c1';
    
    tensorDisp(1,2,1).C = '-c2';
    tensorDisp(1,1,2).C = '-c2';
    tensorDisp(2,1,1).C = '-c2';
    tensorDisp(2,2,2).C = 'c2';
    ...
    CPrompt = 'Please enter values for [c1, c2]. \n';
    CArray = input(CPrompt);
    
	tensors.Cijk(1,1,1) = -CArray(1);
    tensors.Cijk(1,2,2) = CArray(1);
    tensors.Cijk(2,2,1) = CArray(1);
    tensors.Cijk(2,1,2) = CArray(1);
    
    tensors.Cijk(1,2,1) = -CArray(2);
    tensors.Cijk(1,1,2) = -CArray(2);
    tensors.Cijk(2,1,1) = -CArray(2);
    tensors.Cijk(2,2,2) = CArray(2);
