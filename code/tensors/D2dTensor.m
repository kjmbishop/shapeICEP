function tensors = D2dTensor
%TdTensor Prompts user for D2d tensor information and outputs Cijk and Dijk
...
%   plus an example particle shape stored in shapeB
    ...
    tensorDisp(3,2,1).C = 'c1';
    tensorDisp(3,1,2).C = 'c1';
    ...
    CPrompt = 'Please enter values [c1, c2]. \n';
