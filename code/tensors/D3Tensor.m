function tensors = D3Tensor
%TdTensor Prompts user for D3 tensor information and outputs Cijk and Dijk
...
%   plus an example particle shape stored in shapeB
    ...
    tensorDisp(1,2,3).C = '-c2';
    tensorDisp(1,3,2).C = '-c2';
    ...
    tensors.Cijk(1,2,3) = -CArray(2);
    tensors.Cijk(1,3,2) = -CArray(2);
