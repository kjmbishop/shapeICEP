function tensors = CnTensor
%TdTensor Prompts user for Cn tensor information and outputs Cijk and Dijk
...
%   plus an example particle shape stored in shapeB
	...
	tensorDisp(1,2,3).C = '-c4';
    tensorDisp(1,3,2).C = '-c4';
    tensorDisp(2,1,3).C = 'c4';
    tensorDisp(2,3,1).C = 'c4';
    
    tensorDisp(3,3,3).C = 'c1';
	
    tensorDisp(3,1,1).C = 'c2';
    tensorDisp(3,2,2).C = 'c2';
	
    tensorDisp(1,1,3).C = 'c3';
	tensorDisp(1,3,1).C = 'c3';
	tensorDisp(2,2,3).C = 'c3';
	tensorDisp(2,3,2).C = 'c3';
	...
	tensors.Cijk(1,2,3) = -CArray(4);
    tensors.Cijk(1,3,2) = -CArray(4);
    tensors.Cijk(2,1,3) = CArray(4);
    tensors.Cijk(2,3,1) = CArray(4);
    
    tensors.Cijk(3,3,3) = CArray(1);
	
    tensors.Cijk(3,1,1) = CArray(2);
    tensors.Cijk(3,2,2) = CArray(2);
	
    tensors.Cijk(1,1,3) = CArray(3);
	tensors.Cijk(1,3,1) = CArray(3);
	tensors.Cijk(2,2,3) = CArray(3);
	tensors.Cijk(2,3,2) = CArray(3);
